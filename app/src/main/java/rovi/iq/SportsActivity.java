...
public class SportsActivity extends AppCompatActivity {
    ...
    SportsQuizHelper sportsQuizHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sportsQuizHelper = new SportsQuizHelper(this);
        //Make db writable
        sportsQuizHelper.getWritableDatabase();
        ...
        if (sportsQuizHelper.getAllOfTheQuestions().size() == 0) {
            //If not added then add the ques,options in table
            sportsQuizHelper.allQuestion();
        }

        //This will return us a list of data type TriviaQuestion
        list = sportsQuizHelper.getAllOfTheQuestions();
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(SportsActivity.this);
