...
public class GeneralKnowledgeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       questionText = (TextView) findViewById(R.id.triviaQuestion);
        ...
        gKQuizHelper = new GKQuizHelper(this);
        //Make db writable
        gKQuizHelper.getWritableDatabase();
        ...
        if (gKQuizHelper.getAllOfTheQuestions().size() == 0) {
            //If not added then add the ques,options in table
            gKQuizHelper.allQuestion();
        }

        //This will return us a list of data type TriviaQuestion
        list = gKQuizHelper.getAllOfTheQuestions();
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(GeneralKnowledgeActivity.this);
