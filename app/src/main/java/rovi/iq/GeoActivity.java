...
public class GeoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        geoQuizHelper = new GeoQuizHelper(this);
        //Make db writable
        geoQuizHelper.getWritableDatabase();
        ...
        if (geoQuizHelper.getAllOfTheQuestions().size() == 0) {
            //If not added then add the ques,options in table
            geoQuizHelper.allQuestion();
        }

        //This will return us a list of data type TriviaQuestion
        list = geoQuizHelper.getAllOfTheQuestions();
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(GeoActivity.this);
